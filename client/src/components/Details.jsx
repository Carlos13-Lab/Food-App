...
import { getRecipesById, clearDetailsState} from '../actions/index'
...
export default function Detail (){
  ...
  {dispatch(getRecipesById(id))
    dispatch(clearDetailsState())} ,[dispatch, id]) 
  ...
  return (
     ...
     { 
       ...
       <div className={styles.dt}> 
           ...
           <img className={styles.imga} 
            src={detailsstate[0].img  ? detailsstate[0].img 
          ...
          <div className={styles.container} > <h2 className={styles.loading} > loading... </h2>
            <img className={styles.img}  src="https://1.bp.blogspot.com/-PVZwzW4zlB8/XIpg9KOsxrI/AAAAAAAA1mI/5oEwZcby3nsdnmNRJ9WAR1r5xkmCp2MxwCLcBGAs/s1600/simpos.gif" />
